...
class UploadSequenceFile extends React.Component {
  static getDerivedStateFromProps(nextProps) {
    return {
      ...
      groupTableData: nextProps.groupTableData,
    };
  }
  ...
  checkData = value => {
    ...
    const groupTableDataSampleList = [];
    groupTableData.forEach(row => {
      groupTableDataSampleList.push(row.sampleName);
      groupTableDataSampleList.push(row.sample);
    });
